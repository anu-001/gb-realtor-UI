...
export default function PropertyMediaPage() {
        ...
        <section className="rounded-[32px] border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-card">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-2">
              ...
              <h1 className="font-display text-h2 text-[var(--color-text-primary)]">Property media.</h1>
              <p className="max-w-2xl text-body text-[var(--color-text-secondary)]">
                Upload, reorder, and confirm images.
              </p>
            </div>
            <Link
              to="/agent/listings"
  ...
  return (
    <EmptyState
      ...
      message="Enter a property ID to open the gallery."
      action={
